<%@ Page Title="Associar Relatórios" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="AssociateReport.aspx.vb" Inherits="AssociateReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div class="container">
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    <span>Associe qualquer usuário para ter acesso ao relatório <label id="lbl_title" runat="server"></label>.</span>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12">
                    <label>Associar usuários ao relatório</label>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="DisassociateReport.aspx?id=<%#: DataBinder.Eval(Container.DataItem, "REPORT_ID") & "&email=" & DataBinder.Eval(Container.DataItem, "USER_EMAIL") %>">
