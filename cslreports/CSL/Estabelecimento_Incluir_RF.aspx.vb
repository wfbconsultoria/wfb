...
Partial Class Estabelecimento_Incluir_RF
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("COD_PERFIL_LOGIN") = 3 Then Acesso = True 'Coordenador
        ...
        'Verifica se já existe variável de sessão para CNPJ
        ...
        If dtr.HasRows Then
            ...
            If Not IsDBNull(dtr("NOME_FANTASIA")) Then txt_Nome_Fantasia.Text = M.ConverteTexto(dtr("NOME_FANTASIA"))
        ...
        If Request.QueryString("INCLUSO_CLIENTE") = False Then
            If M.ExecutarSQL(sql) = True Then
                If (cmb_USUARIOS.Text = "@") Then
                    Alert("Estabelecimento incluido com Sucesso", True, "Estabelecimentos_Pesquisa_RF.aspx")
                    Exit Sub
                Else
                ...
                End If
            Else
                Response.Write("<script>alert('Não foi possível cadastrar');history.back();</script>")
            End If
        Else
            If (cmb_USUARIOS.Text = "@") Then
