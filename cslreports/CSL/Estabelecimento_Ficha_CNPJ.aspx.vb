...
Partial Class Estabelecimento_Ficha_CNPJ
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Estabelecimento_Ficha_CNPJ.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("CNPJ") = "" Then
            Alert("Nenhum cliente selecionado, você será redirecionado para sua lista de clientes!", True, "Estabelecimentos_Localizar_CNPJ.aspx")
        End If
    End Sub
