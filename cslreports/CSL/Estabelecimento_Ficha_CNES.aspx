<%@ Page Language="VB" Debug="true" AutoEventWireup="false" CodeFile="Estabelecimento_Ficha_CNES.aspx.vb" Inherits="Estabelecimento_Ficha_CNES" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Ficha de Cliente CNES</div>
    <div id ="Titulo_Pagina_Links">
        <a href="Estabelecimentos_Localizar_CNES.aspx">LIsta de  Estabelecimentos CNES</a>
    </div>
</div>
<br />
    <div id ="Corpo">
    ...
    <asp:SqlDataSource ID="dts_Estabelecimentos" runat="server" 
        ...
        SelectCommand="SELECT * FROM [tbl_CNES_Estabelecimentos_Mercado] WHERE ([cnes] = @cnes)">
        <SelectParameters>
            <asp:QueryStringParameter Name="cnes" QueryStringField="CNES" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    </form> 
</body>
