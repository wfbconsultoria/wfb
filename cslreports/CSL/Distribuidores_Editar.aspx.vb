...
Partial Class Distribuidores_Editar
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Distribuidores_Editar.aspx"
    Dim Titulo As String = "Alterar Distribuidor - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
    ...
    End Sub
    'Código customizado da página
    Protected Sub frm_DISTRIBUIDOR_EDITAR_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles frm_DISTRIBUIDOR_EDITAR.ItemUpdated
        sql = ""
        sql = "Update TBL_DISTRIBUIDORES SET ALTERACAO_EMAIL = '" & Session("EMAIL_LOGIN") & "', ALTERACAO_DATA = '" & M.RecuperaData & "' WHERE CNPJ = " & CNPJ
        M.ExecutarSQL(sql)
        Alert("Distribuidor atualizado com sucesso!", True, "Distribuidores_Ficha.aspx?CNPJ=" & CNPJ)
    End Sub
    Protected Sub cmd_Cancelar_Click(sender As Object, e As EventArgs)
        Response.Redirect("Distribuidores_Ficha.aspx?CNPJ=" & CNPJ)
    End Sub
