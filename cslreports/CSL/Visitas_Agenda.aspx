...
<div id ="Corpo">
    ...
    <asp:GridView ID="gdv_Agenda" runat="server" Width="100%" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="dts_Proximas_Visitas" GridLines="None">
        <Columns>
            ...
            <asp:BoundField DataField="DATA_PROXIMA_EXTENSO" HeaderText="Data" ReadOnly="True" SortExpression="DATA_PROXIMA_VALOR" >
            <HeaderStyle HorizontalAlign="Left" VerticalAlign="Middle" />
            </asp:BoundField>
    ...
    <asp:SqlDataSource ID="dts_Proximas_Visitas" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_VISITAS] WHERE (([EMAIL_VISITANTE] = @EMAIL_VISITANTE) AND ([DATA_PROXIMA_VALOR] &gt; @DATA_PROXIMA_VALOR))">
        <SelectParameters>
            <asp:ControlParameter ControlID="cmb_REPRESENTANTES" Name="EMAIL_VISITANTE" PropertyName="SelectedValue" Type="String" />
            <asp:SessionParameter Name="DATA_PROXIMA_VALOR" SessionField="HOJE" Type="Decimal" />
        </SelectParameters>
    </asp:SqlDataSource>
