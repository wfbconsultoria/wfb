...
Partial Class Usuarios_Localizacao
    ...
    Dim Pagina As String = "Usuarios_Localizacao.aspx"
    Dim Titulo As String = "Lista de usuários - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
    ...
    Protected Sub gdv_Localizar_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles gdv_Localizar.SelectedIndexChanged
        ...
        Response.Redirect("Usuarios_Atualizar.aspx?email=" & Session("EMAIL_USUARIO"))
    End Sub
