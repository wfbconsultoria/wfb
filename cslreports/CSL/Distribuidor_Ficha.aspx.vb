...
Partial Class Distribuidor_Ficha
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Distribuidores_Ficha.aspx"
    Dim Titulo As String = "Ficha de Distribuidor - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
