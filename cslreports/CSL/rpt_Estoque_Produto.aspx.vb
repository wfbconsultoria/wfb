...
Partial Class rpt_Estoque_Produto
    ...
    Public Sub Atualiza_Relatorio()
        ...
        PRODUTO = cmb_PRODUTO.Text
        Integer.TryParse(cmb_Anos.Text, ANO)
        If PRODUTO <> "# Selecione" Then
            'ABRE CONEXÕES
            ...
            'RECUPERA VENDAS
            sql = ""
            sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_GERAL_FISCAL_UN_OR WHERE TIPO = 'VENDA UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
            ...
            'RECUPERA DEMANDA
            sql = ""
            sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_GERAL_FISCAL_UN_OR WHERE TIPO = 'DEMANDA UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
            ...
            If ANO > 2015 Then
                ...
                sql = ""
                sql = "SELECT * FROM TBL_MOVIMENTO_ESTOQUE_INICIAL WHERE GRUPO_DISTRIBUIDOR = 'TOTAL' AND TIPO = '03 ESTOQUE' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
            ...
            'RECUPERA ESTOQUE
            sql = ""
            sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_GERAL_FISCAL_UN_OR WHERE TIPO = 'ESTOQUE UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
            ...
            sql_Dst = "SELECT DISTINCT GRUPO FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_FISCAL_UN_OR WHERE ANO = " & ANO & " AND GRUPO <> '01 - CSL BEHRING (Venda Direta)' AND GRUPO <> '(Venda Direta)' ORDER BY GRUPO "
            ...
            Do While dtr_Dst.Read
                ...
                'RECUPERA VENDAS
                sql = ""
                sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_FISCAL_UN_OR WHERE GRUPO = '" & GRUPO_DISTRIBUIDOR & "' AND TIPO = 'VENDA UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
                ...
                'RECUPERA DEMANDA
                sql = ""
                sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_FISCAL_UN_OR WHERE GRUPO = '" & GRUPO_DISTRIBUIDOR & "' AND TIPO = 'DEMANDA UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
                ...
                If ANO > 2015 Then
                    'RECUPERA ESTOQUE INICIAL DO ANO
                    sql = ""
                    sql = "SELECT * FROM TBL_MOVIMENTO_ESTOQUE_INICIAL WHERE GRUPO_DISTRIBUIDOR = '" & GRUPO_DISTRIBUIDOR & "'  AND TIPO = '03 ESTOQUE' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
                ...
                If ANO = 2015 Then
                    sql = ""
                    sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_FISCAL_UN_OR WHERE GRUPO = '" & GRUPO_DISTRIBUIDOR & "' AND TIPO = 'ESTOQUE UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND PRODUTO = '" & PRODUTO & "'"
                Else
                    sql = ""
                    sql = "SELECT * FROM RPT_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_PRODUTO_TOTAL_FISCAL_UN_OR WHERE GRUPO = '" & GRUPO_DISTRIBUIDOR & "' AND TIPO = 'ESTOQUE UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " OR ANO = 2015 AND PRODUTO = '" & PRODUTO & "'"
                End If
    ...
    Protected Sub cmb_LINHA_Load(sender As Object, e As EventArgs) Handles cmb_PRODUTO.Load
        Atualiza_Relatorio()
    End Sub
End Class