Partial Class Menu_Listas
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Menu_Operacoes.aspx"
    Dim Titulo As String = "Operações - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("COD_PERFIL_LOGIN") = 20 Then Acesso = True 'Distribuidor
        If Session("COD_PERFIL_LOGIN") = 30 Then Acesso = True 'Visitante
