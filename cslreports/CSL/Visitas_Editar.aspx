...
<div id="Titulo_Pagina">
    ...
    <div id ="Titulo_Pagina_Links"><a href="Visita_Ficha.aspx?ID_VISITA=<%=Session("ID_VISITA")%>">Voltar</a>&nbsp;</div>
...
<div id ="Corpo">
    ...
    <asp:FormView ID="frm_Visita" runat="server" DataSourceID="dts_Visitas" style="margin-right: 470px" Width="100%">
            ...
            <ItemTemplate>
                ...
                &nbsp;- <strong>Data: </strong>
                <asp:Label ID="DATALabel" runat="server" Text='<%# Eval("DATA_EXTENSO") %>' />
                <br />
                ...
                &nbsp;-
                <asp:Label ID="CARGOLabel" runat="server" Text='<%# Eval("CARGO_ESTABELECIMENTO") %>' />
                &nbsp;-
                <asp:Label ID="AREALabel" runat="server" Text='<%# Eval("AREA_ESTABELECIMENTO") %>' />
                <br />
                ...
                <asp:Label ID="PROXIMA_VISITALabel" runat="server" Text='<%# Eval("DATA_PROXIMA_EXTENSO") %>' />
                <br />
    ...
    <br />
        ...
        <asp:SqlDataSource ID="dts_Visitas" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_VISITAS] WHERE ([ID_VISITA] = @ID_VISITA)">
            <SelectParameters>
