<%@ Page Title="Check In/Out Terceiros" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="CheckIn_List_Terceiros.aspx.vb" Inherits="lojas_WFB_CheckIn_List_Terceiros" %>
            ...
            <asp:Repeater ID="dtrColaboradores" runat="server" DataSourceID="dtsColaboradores">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="text-center" style="text-align: center;"><a class='<%#"btn btn-lg btn-" + DataBinder.Eval(Container.DataItem, "cor").ToString %>' href='<%# "CheckIn_Form_Terceiros.aspx?IdColaborador" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString %>'><%#DataBinder.Eval(Container.DataItem, "Acao").ToString %></a></td>
                        </ItemTemplate>
            </asp:Repeater>
        </tbody>
        <tfoot>
