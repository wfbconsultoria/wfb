Imports System.Net
Imports System.IO
'SIASG_11_RESULTADOS_DOWNLOAD
Module Module1
    Public titulo_aplicacao As String = "SIASG - 11 RESULTADOS DOWNLOAD"
    ...
    Public view_download As String = "DOWNLOAD_11_RESULTADOS"
    Public pasta_csv As String = "D:\SIASG\11_RESULTADOS\ARQUIVOS\"
    Public erros As Integer = 0
    Public tipo_arquivo As String = "RESULTADO"
                ...
                Do While dtr.Read()
                    Do
                        Try
                            ...
                            Dim remoteUri As String = dtr(tipo_arquivo & "_LINK")
                            Dim fileName As String = ""
                            fileName &= pasta_csv & tipo_arquivo & "_"
                            fileName &= dtr("COD_LICITACAO") & "_"
                            fileName &= dtr("COD_PREGAO") & "_"
                            fileName &= Format(Val(dtr("NUMERO_PREGAO")), "0000000000") & "_"
                            fileName &= Format(Val(dtr("COD_UASG")), "0000000000") & "_"
                            fileName &= Format(Val(dtr("ID_FORNECEDOR")), "0000000000") & ".CSV"
                            ...
                            If fi_size > 0 Then
                                ...
                                ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & offset & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'SUCESSO' WHERE [RESULTADO_LINK] = '" & dtr("RESULTADO_LINK") & "'")
                                Exit Do
                                'offset = offset + 500
                            Else
                                If offset = 0 Then
                                    'erros += 1
                                    'fi.Delete()
                                    Mensagem("NOT FOUND; " & Now() & "; " & fileName & " - EXCLUIDO")
                                    ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & -1 & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'FALHA - EMPTY FILE OR NOT FOUND' WHERE [RESULTADO_LINKO] = '" & dtr("RESULTADO_LINK") & "'")
                                    Exit Do
                                Else
                                    Exit Do
                                End If
                        ...
                        Catch exc2 As Exception
                            If offset = 0 Then
                                erros += 1
                                ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & -1 & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'FALHA " & exc2.Message & "' WHERE [RESULTADO_LINK] = '" & dtr("RESULTADO_LINK") & "'")
                                LogErro(exc2)
                                Exit Do
                            Else
                                offset = 0
