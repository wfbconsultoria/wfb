...
Module Module1
    ...
    Sub Main()
        ...
        Console.Title = COD_CLASSE & " SIASG " & tipo_arquivo & " " & tipo_processo & " Inicio " & Now()
        ...
        Try
            ...
            Dim sql As String = "SELECT * FROM [" & schema & "].[" & tabela & "] WHERE [" & tipo_arquivo & "_IMPORTAR] = 1 AND [" & tipo_arquivo & "_OFFSET] < 0 "
                ...
                Do While dtr.Read()
                    Do
                        Try
                            ...
                            Dim fileName As String = pasta_csv & "MATERIAS_PDM_" & Format(Val(dtr("Código")), "000000") & "_OFFSET_" & Format(offset, "0000000000") & ".CSV"
