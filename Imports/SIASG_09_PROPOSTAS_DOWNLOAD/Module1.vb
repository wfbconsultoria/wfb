...
Module Module1
    Public titulo_aplicacao As String = "SIASG_GHI - 09 PROPOSTAS DOWNLOAD"
    ...
    Public view_download As String = "DOWNLOAD_09_PROPOSTAS_6515"
    ...
    'SIASG_09_PROPOSTAS_DOWNLOAD
    Sub Main()
        Console.Title = "6515 - " & tipo_arquivo & " " & tipo_processo & " Inicio " & Now()
                    ...
                    Do
                        Try
                            ...
                            If fi_size > 0 Then
                                ...
                                ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & offset & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'SUCESSO' WHERE [COD_LICITACAO] = '" & dtr("COD_LICITACAO") & "' AND [COD_ITEM] = '" & dtr("COD_ITEM") & "'")
                                Exit Do
                                'offset = offset + 500
                            Else
                                If offset = 0 Then
                                    ...
                                    ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & -1 & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'FALHA - EMPTY FILE OR NOT FOUND' WHERE [COD_LICITACAO] = '" & dtr("COD_LICITACAO") & "' AND [COD_ITEM] = '" & dtr("COD_ITEM") & "'")
                                    Exit Do
                                Else
                                    Exit Do
                                End If
                        ...
                        Catch exc2 As Exception
                            If offset = 0 Then
                                ExecuteSQL("UPDATE [" & schema & "].[" & tabela & "] Set [" & tipo_arquivo & "_OFFSET] = " & -1 & ", [" & tipo_arquivo & "_ATUALIZACAO] = '" & Agora() & "', [" & tipo_arquivo & "_LOG] = 'FALHA " & exc2.Message & "' WHERE [COD_LICITACAO] = '" & dtr("COD_LICITACAO") & "' AND [COD_ITEM] = '" & dtr("COD_ITEM") & "'")
                                LogErro(exc2)
                                Exit Do
                            Else
                                offset = 0
