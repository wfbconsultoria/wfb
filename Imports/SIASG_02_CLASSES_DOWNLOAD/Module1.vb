...
Module Module1
    ...
    Public tabela As String = "TB_CATMAT_GRUPOS"
    Public pasta_csv As String = "D:\SIASG\02_CLASSES\ARQUIVOS\"
    Public erros As Integer = 0
    Public tipo_arquivo As String = "CLASSES"
                ...
                Do While dtr.Read()
                    Do
                        Try
                            ...
                            Dim fileName As String = pasta_csv & "CLASSES_GRUPO_" & Format(Val(dtr("Código")), "000000") & "_OFFSET_" & Format(offset, "0000000000") & ".CSV"
