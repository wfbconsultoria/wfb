Imports System.Net
Imports System.IO
'SIASG_06_LICITACOES_ITENS_DOWNLOAD_GHI_MEDITRONIC
Module Module1
    Public titulo_aplicacao As String = "SIASG - LICITACOES ITENS DOWNLOAD"
    ...
    Sub Main()
        ...
        Console.WriteLine("ITENS LICITAÇÕES A IMPORTAR (1=NÃO IMPORTADAS; 2=IMPORTADAS COM FALHA)")
            ...
            If dtr.HasRows Then
                Do While dtr.Read()
                    ...
                    Try
                        ...
                        Dim fileName As String = pasta_csv & "LICITACOES_ITENS_" & dtr("COD_LICITACAO") & "_OFFSET_" & Format(offset, "0000000000") & ".CSV"
