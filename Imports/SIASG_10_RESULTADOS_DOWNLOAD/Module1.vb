...
Module Module1
    Public titulo_aplicacao As String = "SIASG - 10 RESULTADOS DOWNLOAD"
    ...
    Public view_download As String = "DOWNLOAD_10_RESULTADOS"
    Public pasta_csv As String = "S:\SIASG\10_RESULTADOS\ARQUIVOS\"
    ...
    'SIASG_GHI_10_RESULTADOS_DOWNLOAD
    Sub Main()
