...
Module Module1
    ...
    Public tabela As String = "TB_FORNECEDORES"
    Public colunas_tabela As Integer = 15
                ...
                Using leitorArquivoCSV As New TextFieldParser(FI.FullName)
                    ...
                    While Not leitorArquivoCSV.EndOfData
                        ...
                        Try
                            ...
                            strSql &= "[Município],"
                            strSql &= "[UF],"
                            strSql &= "[Natureza Jurídica],"
                            strSql &= "[Porte da Empresa],"
                            strSql &= "[Ramo do Negócio],"
                            strSql &= "[Unidade Cadastradora],"
                            strSql &= "[CNAE],"
                            strSql &= "[CNAE Secundário],"
                            strSql &= "[Habilitado a Licitar]"
                            strSql &= ") Values ("
                            colunas_arquivo = 0
