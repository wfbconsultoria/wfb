Imports System.Net
Imports System.IO
'SIASG_10_RESULTADOS_DOWNLOAD
Module Module1
    Public titulo_aplicacao As String = "SIASG - 10 RESULTADOS LINKS DOWNLOAD"
    ...
    Public view_download As String = "DOWNLOAD_10_RESULTADOS_6515"
    ...
    'SIASG_GHI_10_RESULTADOS_LINKS_DOWNLOAD
    Sub Main()
        Console.Title = "SIASG " & tipo_arquivo & " LINKS " & tipo_processo & " Inicio " & Now()
                ...
                Do While dtr.Read()
                    Do
                        Try
                            ...
                            Dim remoteUri As String = Replace(Replace(Replace(dtr(tipo_arquivo & "_LINK"), "html", "csv"), ",", ""), "co_uasg", "&co_uasg")
                            Dim fileName As String = pasta_csv & tipo_arquivo & "_" & dtr("COD_LICITACAO") & ".CSV"
