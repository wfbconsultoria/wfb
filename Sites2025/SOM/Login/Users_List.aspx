<%@ Page Title="" Language="VB" MasterPageFile="~/Shared/Master.master" AutoEventWireup="false" CodeFile="Users_List.aspx.vb" Inherits="Login_Users_List" %>
    ...
    <table id="table"
        ...
        <tbody>
            <asp:Repeater ID="dtr" runat="server" DataSourceID="dts">
                <ItemTemplate>
                    <tr>
                        <td><a href='<%# "User.aspx?EMAIL" + "=" + DataBinder.Eval(Container.DataItem, "EMAIL").ToString%>'><%# DataBinder.Eval(Container.DataItem, "EMAIL").ToString%></a></td>
