...
Partial Class Usuario_Incluir
    ...
    Sub InsertRecord()
        If ValidateRecord() = True Then
            ...
            If m.ExecuteSQL(sql) = True Then
                ...
                strMESSAGE &= "Acesse " & ConfigurationManager.AppSettings("App.Url") & "<br/> "
    ...
    Sub RecoverRecord()
        ...
        If dtr.HasRows Then
            ...
            NOME.Value = dtr("NOME")
            If Not IsDBNull(dtr("CELULAR")) Then CELULAR.Value = dtr("CELULAR")
    ...
    Sub UpdateRecord()
        If ValidateRecord() = True Then
            ...
            sql &= "SET "
            sql &= "[NOME] = '" & m.ConvertText(NOME.Value, clsMaster.TextCaseOptions.UpperCase) & "'"
            sql &= ",[CELULAR] = '" & m.ConvertText(CELULAR.Value, clsMaster.TextCaseOptions.UpperCase) & "'"
