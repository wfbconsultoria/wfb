            ...
            <table class="table table-bordered" id="table_totais">
                <thead>
                    <asp:Repeater ID="dtr_TOTAIS" runat="server" DataSourceID="dts_TOTAIS">
                        <ItemTemplate>
                            <tr>
                                <td class="text-muted"> &nbsp<strong><%# DataBinder.Eval(Container.DataItem, "MEDICOS").ToString%></strong> médicos/contatos em
                                 <strong><%# DataBinder.Eval(Container.DataItem, "ESTABELECIMENTOS").ToString%></strong> estabelecimentos</td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
            </table>
