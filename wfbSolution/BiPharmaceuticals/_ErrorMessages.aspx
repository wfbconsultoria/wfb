<%@ Page Title="Menasgem do Sistema" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Master.Master" CodeBehind="_ErrorMessages.aspx.vb" Inherits="BiPharmaceuticals._ErrorMessages" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel runat="server" ID="pnl_Message" CssClass="alert alert-danger">
        ...
        <hr>
        <p class="mb-0">
            <asp:LinkButton ID="cmdBack" runat="server" CssClass="alert-link">Voltar</asp:LinkButton>
