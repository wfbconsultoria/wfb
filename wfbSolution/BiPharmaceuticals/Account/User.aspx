<%@ Page Title="Usuario" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Master.Master" CodeBehind="User.aspx.vb" Inherits="BiPharmaceuticals.User" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    &nbsp;<a href="User.aspx?Email=NOVO" class=" btn btn-primary">Novo</a>
    &nbsp;<input id="cmd_Cancel" type="reset" value="Cancelar" class="btn btn-light" />
    &nbsp; <a href="Users.aspx" class="btn btn-link btn-light">Lista</a>
