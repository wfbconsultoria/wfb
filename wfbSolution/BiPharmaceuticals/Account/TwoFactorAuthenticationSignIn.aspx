<%@ Page Title="Autenticação de dois fatores" Language="vb" MasterPageFile="~/_Master.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="BiPharmaceuticals.TwoFactorAuthenticationSignIn" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    Selecione o provedor de autenticação de dois fatores:
                        <asp:DropDownList runat="server" ID="Providers"></asp:DropDownList>
