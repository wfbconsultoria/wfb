<%@ Page Title="Login" Language="vb" AutoEventWireup="false" MasterPageFile="~/_MasterLogin.Master" CodeBehind="Login.aspx.vb" Inherits="BiPharmaceuticals.Login" Async="true" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="row">
        <div class="col-md-6">
            <img class="img-fluid" width=240  src="/Images/_Logo.png" />
