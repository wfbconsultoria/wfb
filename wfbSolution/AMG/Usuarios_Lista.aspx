        ...
        <table id="table"
            ...
            <thead>
                <tr>
                    ...
                    <th data-field="PERFIL" data-sortable="true" style="width: 30%">Nome</th>
                    <th data-field="CELULAR" data-sortable="true" style="width: 20%">Celular</th>
                    <th data-field="STATUS" data-sortable="true" style="width: 10%">Status</th>
                </tr>
            </thead>
            <tbody>
                <asp:Repeater ID="dtr" runat="server" DataSourceID="dts">
                    <ItemTemplate>
                        <tr>
                            <td><a href='<%# "Usuario_Incluir.aspx?ID" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString%>'><%# DataBinder.Eval(Container.DataItem, "APELIDO").ToString%></a></td>
                            <td><%# DataBinder.Eval(Container.DataItem, "PERFIL").ToString%></td>
