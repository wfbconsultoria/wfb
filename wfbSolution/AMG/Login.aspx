...
<body>
    <main class="form-signin w-100 m-auto">
        ...
        <form id="frmLogin" runat="server">
            ...
            <div class="form-floating">
                <input runat="server" id="txtSenha" type="password" class="form-control" placeholder="Password" required="required" />
                <label for="txtSenha">Senha</label>
            </div>

            <button runat="server" id="cmdLogin" class="w-100 btn btn-lg btn-dark" type="submit" causesvalidation="true">Sign in</button>
