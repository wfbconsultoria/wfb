<%@ Page Title="Redefinir senha" Language="vb" MasterPageFile="~/_Master_Public.Master" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.vb" Inherits="CannaMedsBrasil.ResetPassword" Async="true" %>
