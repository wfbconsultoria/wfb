<%@ Page Title="CheckIn/Out" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="CheckIn_List.aspx.vb" Inherits="Chapeira_Eplanner.CheckIn_List" %>
    ...
    <table class="table demo table-bordered table-hover " data-filter="#filter" data-paging="true" data-filter-text-only="true" data-page-size="1000">
        <thead class="navbar-default">
            <tr>
                ...
                <th class="text-center"  style="width: 20%">Planner</th>
            </tr>
        </thead>
        <tbody>
            <asp:Repeater ID="dtrColaboradores" runat="server" DataSourceID="dtsColaboradores">
                <ItemTemplate>
                    <tr>
                        <td class="text-center" style="text-align: center; width:20%">
                        ...
                        <td class="text-primary" style="font-size:medium; width: 40%"><%# DataBinder.Eval(Container.DataItem, "Nome").ToString%></td>
                        ...
                        <td class="text-center" style="text-align: center; width: 20%"><a class='<%#"btn btn-sm  btn-" + DataBinder.Eval(Container.DataItem, "cor").ToString %>' href='<%# "CheckIn_Form.aspx?IdColaborador" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString %>'><%#DataBinder.Eval(Container.DataItem, "Acao").ToString %></a></td>
                        <td class="text-center" style="text-align: center; width: 20%"><a class="btn btn-sm  btn-primary" href='<%# "CheckIn_Form.aspx?IdColaborador" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString %>'>planner</a></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
        </tbody>
