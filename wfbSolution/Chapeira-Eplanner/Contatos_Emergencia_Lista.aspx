<%@ Page Title="Contatos Emergência (Cadastro)" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Contatos_Emergencia_Lista.aspx.vb" Inherits="Chapeira_Eplanner.Contatos_Emergencia_Lista" %>
    ...
    <br />
     ...
     <table class="table demo table-bordered table-hover " data-filter="#filter" data-paging="true" data-filter-text-only="true" data-page-size="50">
        ...
        <tfoot>
            <tr>
                <td colspan="7">
                    Emitido em <%:Now() %> - Chapeira_Eplanner <%:ConfigurationManager.AppSettings("Loja") %>
                </td>
            </tr>
        </tfoot>
    </table>
