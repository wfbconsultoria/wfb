<%@ Page Title="Colaboradores Inativos" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Colaboradores_Inativos.aspx.vb" Inherits="Chapeira_Eplanner.Colaboradores_Inativos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            ...
            <span class="input-group-text text-success"><a href="Colaboradores_Ativos.aspx">Ativos</a></span>
