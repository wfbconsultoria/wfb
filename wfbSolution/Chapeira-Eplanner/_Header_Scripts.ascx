<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="_Header_Scripts.ascx.vb" Inherits="Chapeira_Eplanner._Header_Scripts" %>
...
<script src="https://kit.fontawesome.com/3e867150af.js" crossorigin="anonymous"></script>
