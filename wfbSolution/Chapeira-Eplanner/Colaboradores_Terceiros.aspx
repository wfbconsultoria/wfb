<%@ Page Title="Prestadores de Serviços" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Colaboradores_Terceiros.aspx.vb" Inherits="Chapeira_Eplanner.Colaboradores_Terceiros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="input-group">
        ...
        <div class="input-group-append">
            <span class="input-group-text text-primary"><a href="Colaborador_Terceiro.aspx?IdColaborador=NOVO">Novo</a></span>
            ...
            <asp:Repeater ID="dtrColaboradores" runat="server" DataSourceID="dtsColaboradores">
                <ItemTemplate>
                    <tr>
                        ...
                        <td><a href='<%# "Colaborador_Terceiro.aspx?IdColaborador" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString  %>'><%# DataBinder.Eval(Container.DataItem, "Nome").ToString%></a></td>
