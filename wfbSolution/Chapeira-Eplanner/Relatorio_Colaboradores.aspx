<%@ Page Title="Relatório Colaboradores" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Relatorio_Colaboradores.aspx.vb" Inherits="Chapeira_Eplanner.Relatorio_Colaboradores" %>
            ...
            <asp:Repeater ID="dtrColaboradores" runat="server" DataSourceID="dtsColaboradores">
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="<%# DataBinder.Eval(Container.DataItem, "Ativo")%>"><%# DataBinder.Eval(Container.DataItem, "Ativo").ToString%></td>
                        <td class="text-center"><img src="<%# DataBinder.Eval(Container.DataItem, "Brigadista")%>" /></td>
                        <td class="text-center"><img src="<%# DataBinder.Eval(Container.DataItem, "Administrador")%>" /></td>
