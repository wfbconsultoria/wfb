Public Class Colaborador_Terceiro
    ...
    Dim sql As String = ""
    Dim Tipo_Colaborador As String = "Terceiro"
    ...
    Sub InsertRecord()
        ...
        Dim IdKey = m.ConvertText(m.GenerateKey("TER"), clsMaster.TextCaseOptions.UpperCase).ToString

        'If cmb_Brigadista.Value = "Sim" Then Tipo_Colaborador = "Brigadista" Else Tipo_Colaborador = "Colaborador"
        sql = ""
        ...
        m.Alert(Me, txt_Nome.Value & " PRESTADOR DE SERVIÇOS incluido com sucesso!", True, "Colaborador_Terceiro.aspx?IdColaborador=" & c.ColaboradorId)
    End Sub
    ...
    Sub SaveRecord()
        ...
        m.Alert(Me, txt_Nome.Value & " PRESTADOR DE SERVIÇOS atualizado com sucesso!", True, "Colaborador_Terceiro.aspx?IdColaborador=" & c.ColaboradorId)
    End Sub
