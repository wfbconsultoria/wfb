<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DashBoard_Detail_Brigadistas.aspx.vb" Inherits="Chapeira_Eplanner.DashBoard_Detail_Brigadistas" %>
...
<body>
    <form id="frm_Mensagem" runat="server">
        <div class="container">
            ...
            <h4 class="text-danger"><%:Page.Title%> - <%:Now() %></h4>
            <%-- Relatório--%>
            <table>
