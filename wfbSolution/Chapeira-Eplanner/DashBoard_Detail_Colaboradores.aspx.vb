Imports System.IO
Imports System.Net
Public Class DashBoard_Detail_Colaboradores
    ...
    Sub ConfigReport(ReportId As String)
        ...
        Dim sql As String = "Select * From View_Colaboradores Where Loja_Sigla = '" & ConfigurationManager.AppSettings("Loja_Sigla") & "' and Ativo = 'Sim' and Grupo = 'COLABORADORES' "
    ...
    Private Function RetornaDocumentText(ByVal url As String) As String
        If Not url.StartsWith("https://", StringComparison.OrdinalIgnoreCase) Then Return String.Empty
