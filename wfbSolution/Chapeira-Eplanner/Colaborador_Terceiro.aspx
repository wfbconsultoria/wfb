<%@ Page Title="Prestador de Serviço" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Colaborador_Terceiro.aspx.vb" Inherits="Chapeira_Eplanner.Colaborador_Terceiro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <div class="form-row">
        ...
        <%--Admissão--%>
        <div class="form-group col-sm-2">
            <label class="text-primary">Início</label>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-4">
            ...
            <input runat="server" id="txt_Email" type="email" maxlength="128" class="form-control" placeholder="Email (opcional)" />
        </div>
        <%--Telefone--%>
        <div class="form-group col-sm-4">
            <label class="text-primary">Telefone</label>
            <input runat="server" id="txt_Telefone" type="text" maxlength="128" class="form-control" placeholder="Telefone (opcional)" />
        </div>
        <%--Funcao--%>
        <div class="form-group col-sm-4">
            <label class="text-primary">Função</label>
            <input runat="server" id="txt_Funcao" type="text" maxlength="128" class="form-control" placeholder="Função (opcional)"/>
        </div>
    </div>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-12">
            ...
            <input runat="server" id="txt_Endereco" type="text" maxlength="128" class="form-control" placeholder="Endereço (opcional)" />
        </div>
    </div>
    <div class="form-row">
        <%-- Cidade--%>
        <div class="form-group col-sm-10">
            ...
            <input runat="server" id="txt_Cidade" type="text" maxlength="128" class="form-control" placeholder="Cidade (opcional)" />
        </div>
        <%-- UF--%>
        <div class="form-group col-sm-2">
    ...
    &nbsp;<a href="Colaborador_Terceiro.aspx?IdColaborador=NOVO" class=" btn btn-primary">Novo</a>
    &nbsp;<input id="cmd_Cancel" type="reset" value="Cancelar" class="btn btn-light" />
    &nbsp; <a href="Colaboradores_Terceiros.aspx" class="btn btn-link btn-light">Lista</a>
