Public Class User_Register
    ...
    Private Sub cmd_Salvar_ServerClick(sender As Object, e As EventArgs) Handles cmd_Salvar.ServerClick
        ...
        If m.ExecuteSQL(sql) = True Then
            ...
            Mensagem &= "Sua senha é <strong>" & Password & "</strong><br/>"
            Mensagem &= "Link para acesso <strong>" & ConfigurationManager.AppSettings("App.URL").ToString & "</strong><br/><br/>"
            ...
            m.Alert(Me, txt_Email.Value & " incluido com sucesso", "Users.aspx")
        End If
        Exit Sub
