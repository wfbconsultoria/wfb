...
public partial class RegisterProcedureDatabase : System.Web.UI.Page
{
    ...
    protected void btnRegister_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            string database = m.ConverText(clsMaster.TextKeyOption.TextCase, txtBase.Value);
            ...
            //Convertendo aspas simples para não dar erro no banco
            string script = txtScript.Value.Replace("'","||");
            string cnnStr = "";
            string sql = "";
            ...
            if (type == 1)
                ...
                sql = "";
                sql = "INSERT INTO tb_procedure_banco(Nome, Banco, Servidor, Usuario, Senha, Email_Responsavel, Script, Conexao, Tipo) ";
                sql += "VALUES (";
                sql += "'" + name + "', ";
                sql += "'" + database + "', ";
                sql += "'" + server + "', ";
                ...
                if (m.ExecuteSQL(sql) == true)
                {
                    ...
                    m.alertRedirect("Procedimento cadastrado com sucesso","ListProcedureDatabase.aspx?session=" + Request.Params["session"].ToString());
                }
                else
                {
                    //erro ao cadastrar
                    m.alert("Erro ao cadastrar procedimento");
                }
        }
    }
    ...
    protected void btnTestConnection_Click(object sender, EventArgs e)
    {
        ...
        else if (selType.Value == "1")
        {
            ...
            strMySQL += "Database=" + m.ConverText(clsMaster.TextKeyOption.TextCase, txtBase.Value) + ";";
            strMySQL += "Uid=" + m.ConverText(clsMaster.TextKeyOption.TextCase, txtUser.Value) + ";";
            strMySQL += "Pwd=" + password + ";";
            ...
            finally
            {
                ...
                Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "document.getElementById('Body_Content_txtPassword').value = '" + password + "';", true);
            }
        }
        ...
        else if (selType.Value == "2")
        {
            ...
            strSQL += "Initial Catalog=" + m.ConverText(clsMaster.TextKeyOption.TextCase, txtBase.Value) + ";";
