<%@ Page Title="Grupos Distribuidores" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Distribuidores_Grupos_Lista.aspx.vb" Inherits="Distribuidores_Grupos_Lista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div>
        <table id="table"
            ...
            <thead>
                <tr>
                    <th data-field="GRUPO_DISTRIBUIDOR" data-sortable="true" style="width: 40%">Grupo Distribuidor</th>
            ...
            <tbody>
                <asp:Repeater ID="dtr" runat="server" DataSourceID="dts">
                    <ItemTemplate>
                        <tr>
                            <td><a href='<%# "Distribuidores_Grupos_Incluir.aspx?Id" + "=" + DataBinder.Eval(Container.DataItem, "Id").ToString %>'><%# DataBinder.Eval(Container.DataItem, "GRUPO_DISTRIBUIDOR").ToString%></a></td>
