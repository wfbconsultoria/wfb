<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Colaboradores_Lista_Mensagem.aspx.vb" Inherits="Chapeira.Colaboradores_Lista_Mensagem" %>
        ...
        <div class="container">
            ...
            <table>
                ...
                <tr style="border-top: solid">
                    <td colspan="6">Emitido em <%:Now() %> - Chapeira <%:ConfigurationManager.AppSettings("Loja") %></td>
                </tr>
            </table>
            <br />
