<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DashBoard_Detail_Formados.aspx.vb" Inherits="Chapeira.DashBoard_Detail_Formados" %>
...
<body>
    <form id="frm_Mensagem" runat="server">
        ...
        <div class="container-fluid">
            ...
            <h5>Emitido em <%:Now() %> - Chapeira <%:ConfigurationManager.AppSettings("Loja") %></h5>
            <br />
            <br />
        </div>
