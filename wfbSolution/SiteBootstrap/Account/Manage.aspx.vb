    ...
    Protected Sub Page_Load() Handles Me.Load
        If Not IsPostBack Then
            ...
            If message IsNot Nothing Then
                ...
                SuccessMessageText = If(message = "ChangePwdSuccess", "Sua senha foi alterada.", If(message = "SetPwdSuccess", "Sua senha foi definida.", If(message = "RemoveLoginSuccess", "A conta foi removida.", [String].Empty)))
