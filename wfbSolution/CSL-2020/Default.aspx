<%@ Page Title="Início" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Default.aspx.vb" Inherits="CSL_2020._Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
  ...
  <div class="form-row border border-light rounded bg-light" style="padding-top: 10px; padding-left: 10px">
    <div class="form-group col-md-4" >
      ...
      <input  runat="server" type="text" class="form-control" id="txt_nome_contato" placeholder="Nome do contato CSL"/>
    </div>
    <div class="form-group col-md-4" >
      <label for="representante" >E-mail Representante</label>
      <input disabled="disabled" runat="server" type="txt" class="form-control" id="txt_rep" value="bruna.claro@cslbehring.com" />
    </div>
    <div class="form-group col-md-3">
  ...
  <div class="form-row border border-light rounded bg-light" style="padding-top: 10px; padding-left: 10px">
    <div class="form-group col-md-4" >
      ...
      <input  runat="server" type="text" class="form-control" id="txt_nome_contato_mapa" placeholder="Nome do responsavel que envia os mapas"/>
    </div>
    <div class="form-group col-md-5" >
      <label for="e-mail_notificacao" >E-mail de Notificação</label>
      <input  runat="server" type="text" class="form-control" id="txt_email_contato_mapa" placeholder="E-mail que iremos cobrar os mapas"/>
    </div>
    <div class="form-group col-md-3">
  ...
  <div class="form-row border border-light rounded bg-light" style="padding-top: 10px; padding-left: 10px">
    ...
    <div class="form-group col-md-5" >
      ...
      <input  runat="server" type="text" class="form-control" id="txt_email_contato_vendas" placeholder="E-mail que iremos de atendimento"/>
    </div>
    <div class="form-group col-md-3">
