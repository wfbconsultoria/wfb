<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CheckIn_List.aspx.vb" Inherits="SiteEmpty.CheckIn_List" %>
            ...
            <table class="table demo table-bordered table-hover " data-filter="#filter" data-paging="true" data-filter-text-only="true" data-page-size="50">
                ...
                <tbody>
                    <asp:Repeater ID="dtrPessoas" runat="server" DataSourceID="dtsPessoas">
                        <ItemTemplate>
                            <tr>
                                <td style="font-size: x-large; width: 75%"><a href='<%# "ChechOut_Message.aspx?ID" + "=" + DataBinder.Eval(Container.DataItem, "ID").ToString%>'></a><%# DataBinder.Eval(Container.DataItem, "Nome").ToString%></td>
