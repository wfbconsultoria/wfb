<%@ Page Title="Médico" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Medico.aspx.vb" Inherits="Medico" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <asp:SqlDataSource ID="dts_MEDICO" runat="server" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" />
