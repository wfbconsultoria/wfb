<%@ Page Title="DashBoard" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="DashBoard_Sample.aspx.vb" Inherits="EPlanner.DashBoard_Sample" %>
                                        ...
                                        <div class="text-center mt-2">
                                            ...
                                            <ul class="list-inline chart-detail-list mb-0">
                                                <li class="list-inline-item">
                                                    <h5 class="font-14"><i class="fas fa-circle mr-1" style="color: #42a5f5;"></i>Series A</h5>
                                                </li>
                                                <li class="list-inline-item">
                                                    <h5 class="font-14"><i class="fas fa-circle mr-1" style="color: #64b5f6;"></i>Series B</h5>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
