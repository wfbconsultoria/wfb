<%@ Page Title="PLANEJAR HORARIOS" Language="vb" AutoEventWireup="false" MasterPageFile="~/Master.Master" CodeBehind="Planificar_Horarios.aspx.vb" Inherits="EPlanner.Planificar_Horarios" %>
    ...
    <div class="form-row">
        <div class="form-group col-md-12">
            <asp:Label ID="lbl_Data" runat="server" Text="Label" AssociatedControlID="txt_Data">Data</asp:Label>
                <asp:TextBox ID="txt_Data" runat="server" CssClass="form-control"></asp:TextBox>
        </div>
    </div>
