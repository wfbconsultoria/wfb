...
Public Class clsLojas
    ...
    Public Sub GetInfoLoja()
        ...
        Dim cnnLoja As New SqlClient.SqlConnection
        ...
        Dim cmdLoja As SqlClient.SqlCommand = cnnLoja.CreateCommand
        ...
        'Terceiros
        Dim cmdTerceiros As SqlClient.SqlCommand = cnnLoja.CreateCommand
        ...
        'Visitantes
        Dim cmdVisitantes As SqlClient.SqlCommand = cnnLoja.CreateCommand
