...
Public Class clsMaster
    ...
    Public Function CheckLogin() As Boolean
        On Error GoTo Err_CheckLogin
        CheckLogin = False

        If HttpContext.Current.Session("EMAIL_LOGIN") = "" Then
...
Err_ExecuteSQL:
    ...
    Public Function ExecuteSelect(ByVal SQL As String, Optional Ordem As String = "", Optional Onde As String = "") As SqlClient.SqlDataReader
...
Err_CheckExists:
    ...
    Public Function SystemMessage(Mensagem As String, Optional PageTarget As String = "") As String
        Dim UrlMessage = ""
        SystemMessage = ""
        UrlMessage = Mensagem & "PageTarget=" & PageTarget
        UrlMessage = Replace(UrlMessage, Chr(10), " ")
        SystemMessage = UrlMessage
        HttpContext.Current.Response.Redirect("PageMessage.aspx?" & UrlMessage)
    End Function
    ...
    Public Function SendMail(ByVal MailToAddress As String, ByVal MailToName As String, MailSubject As String, ByVal MailMessage As String) As Boolean
        ...
        Dim MailFromName As String = ConfigurationManager.AppSettings("App.Name").ToString & " - " & ConfigurationManager.AppSettings("Loja").ToString
...
Err_SendMail:
    ...
    Public Function GenerateKey(Optional Sigla As String = "") As String
        ...
        GenerateKey = ConfigurationManager.AppSettings("Loja_Sigla").ToString & "-" & Format(Now.Year, "0000") & "-" & Format(Now.Month, "00") & "-" & Format(Now.Day, "00") & "-" & Format(Now.Hour, "00") & "-" & Format(Now.Minute, "00") & "-" & Format(Now.Second, "00") & "-" & Format(Now.Millisecond, "0000") & Sigla & "-"
        Dim Number(26) As String
        Number(0) = "0"
        Number(1) = "1"
        Number(2) = "2"
