<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_Master_Report_KeyAccount.aspx.vb" Inherits="rpt_Master_Report_KeyAccount" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Master Report 
    <asp:DropDownList ID="cmb_GERENTE_CONTA" runat="server" DataSourceID="dts_Gerente_Conta" DataTextField="NOME" DataValueField="EMAIL" AutoPostBack="True" Enabled="False"></asp:DropDownList>
        &nbsp;</div>
...
<div id ="Corpo">
 ...
 <br /> <br />
    ...
    <asp:SqlDataSource ID="dts_Anos" runat="server" 
        ...
        SelectCommand= "SELECT DISTINCT [ANO] FROM [VIEW_DEMANDA_001_DETALHADO] WHERE ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA) ORDER BY [ANO] DESC">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Linha" runat="server" 
        ...
        FROM  VIEW_DEMANDA_001_DETALHADO  WHERE ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA) ORDER BY [LINHA]">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Distribuidores" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_DISTRIBUIDOR UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA)  ORDER BY GRUPO_DISTRIBUIDOR">
         <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Grupo_Estabeleicmento" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_ESTABELECIMENTO UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE (GRUPO_ESTABELECIMENTO &lt;&gt;'') AND ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA)  ORDER BY GRUPO_ESTABELECIMENTO">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
...
SELECT DISTINCT [COD_MUNICIPIO], [MUNICIPIO]  
    ...
    <asp:SqlDataSource ID="dts_Esfera" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
         SelectCommand="SELECT '@' AS ESFERA, '@ Todos' as ESFERA_ADMINISTRATIVA UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA) ORDER BY ESFERA">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Representantes" runat="server" 
        ...
        SelectCommand="SELECT '@' AS EMAIL_REPRESENTANTE, '@  Todos' as REPRESENTANTE UNION ALL 
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA)  ORDER BY REPRESENTANTE">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Demanda" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_DEMANDA_001_DETALHADO] WHERE (([EMAIL_GERENTE_CONTA] = @EMAIL_GERENTE_CONTA)  AND ([ANO] = @ANO))">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_GERENTE_CONTA" SessionField="EMAIL_LOGIN" Type="String" />
