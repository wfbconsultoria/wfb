<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_Master_Report_Representante.aspx.vb" Inherits="rpt_Master_Report_Representante" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Master Report &nbsp;<asp:DropDownList ID="cmb_REPRESENTANTE" runat="server" DataSourceID="dts_Representantes" DataTextField="NOME" DataValueField="EMAIL" AutoPostBack="True" Enabled="False"></asp:DropDownList>
     </div>
...
<div id ="Corpo">
 ...
 <br /> <br />
    ...
    <asp:SqlDataSource ID="dts_Anos" runat="server" 
        ...
        SelectCommand= "SELECT DISTINCT [ANO] FROM [VIEW_DEMANDA_001_DETALHADO] WHERE ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE) ORDER BY [ANO] DESC">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Linha" runat="server" 
        ...
        FROM  VIEW_DEMANDA_001_DETALHADO  WHERE ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE) ORDER BY [LINHA]">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Distribuidores" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_DISTRIBUIDOR UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE)  ORDER BY GRUPO_DISTRIBUIDOR">
         <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Grupo_Estabeleicmento" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_ESTABELECIMENTO UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE (GRUPO_ESTABELECIMENTO &lt;&gt;'') AND ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE)  ORDER BY GRUPO_ESTABELECIMENTO">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
...
SELECT DISTINCT [COD_MUNICIPIO], [MUNICIPIO]  
    ...
    <asp:SqlDataSource ID="dts_Esfera" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
         SelectCommand="SELECT '@' AS ESFERA, '@ Todos' as ESFERA_ADMINISTRATIVA UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE) ORDER BY ESFERA">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Gerente_Conta" runat="server" 
        ...
        SelectCommand="SELECT '@' AS EMAIL_GERENTE_CONTA, '@  Todos' as GERENTE_CONTA UNION ALL 
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE(GERENTE_CONTA &lt;&gt; '') AND ([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE)   ORDER BY GERENTE_CONTA">
    <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Demanda" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_DEMANDA_001_DETALHADO] WHERE (([EMAIL_REPRESENTANTE] = @EMAIL_REPRESENTANTE)  AND ([ANO] = @ANO))">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_REPRESENTANTE" SessionField="EMAIL_LOGIN" Type="String" />
