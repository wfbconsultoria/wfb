...
Partial Class Upload_Sistema
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Public jscript As String
    Dim Pagina As String = "Upload_Sistema.aspx"
    Dim Titulo As String = "Upload de Arquivos de Sistema - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
