...
Partial Class Gerentes_Ficha
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("COD_PERFIL_LOGIN") = "0" Then sql = "SELECT '@' AS EMAIL, '@Selecione' as NOME UNION ALL Select DISTINCT EMAIL as EMAIL, NOME as NOME From VIEW_USUARIOS_ATIVOS Where COD_PERFIL = '2' ORDER BY NOME"
        If Session("COD_PERFIL_LOGIN") = "1" Then sql = "SELECT '@' AS EMAIL, '@Selecione' as NOME UNION ALL Select DISTINCT EMAIL as EMAIL, NOME as NOME From VIEW_USUARIOS_ATIVOS Where EMAIL_DIRETOR= '" & Session("EMAIL_LOGIN") & "' AND COD_PERFIL = '2' ORDER BY NOME"
        If Session("COD_PERFIL_LOGIN") = "2" Then sql = "SELECT '@' AS EMAIL, '@Selecione' as NOME UNION ALL Select DISTINCT EMAIL as EMAIL, NOME as NOME From VIEW_USUARIOS_ATIVOS Where EMAIL= '" & Session("EMAIL_LOGIN") & "' ORDER BY NOME"
    ...
    Private Sub Linha_Demanda_Retrasado(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO = " & ANO_RETRASADO & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (LINHA = '" & LINHA_PRODUTO & "')"
    ...
    Private Sub Linha_Demanda_Passado(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "SUM(AGO) AS AGO, SUM([SET]) AS [SET], SUM(OUT) AS OUT, SUM(NOV) AS NOV, SUM(DEZ) AS DEZ "
        sql = sql & "FROM dbo.VIEW_DEMANDA_001_DETALHADO "
        sql = sql & "WHERE (ANO = " & ANO_PASSADO & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (LINHA = '" & LINHA_PRODUTO & "')"
    ...
    Private Sub Linha_Demanda_Atual(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "SUM(AGO) AS AGO, SUM([SET]) AS [SET], SUM(OUT) AS OUT, SUM(NOV) AS NOV, SUM(DEZ) AS DEZ "
        sql = sql & "FROM dbo.VIEW_DEMANDA_001_DETALHADO "
        sql = sql & "WHERE (ANO = " & ANO_ATUAL & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (LINHA = '" & LINHA_PRODUTO & "')"
    ...
    Private Sub Linha_Oportunidades_025(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO_OPORTUNIDADE = " & ANO_ATUAL & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (LINHA = '" & LINHA_PRODUTO & "')"
    ...
    Private Sub Linha_Bombas(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO = " & ANO_ATUAL & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (COD_GRUPO_BOMBAS = '" & COD_GRUPO_BOMBA & "') AND (TIPO_MOVIMENTO = 'BOMBAS')"
    ...
    Private Sub Linha_Bombas_Representante(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO = " & ANO_ATUAL & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (COD_GRUPO_BOMBA = '" & COD_GRUPO_BOMBA & "')"
    ...
    Private Sub Linha_Cota_Atual(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO = " & ANO_ATUAL & ") AND (EMAIL_GERENTE = '" & EMAIL & "') AND (LINHA_PRODUTO = '" & LINHA_PRODUTO & "')"
