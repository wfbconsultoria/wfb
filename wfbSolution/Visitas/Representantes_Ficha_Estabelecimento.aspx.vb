Imports System.Math
Imports System
Partial Class Representantes_Ficha_Estabelecimento
    Inherits System.Web.UI.Page
    Dim M As New clsMaster
    Dim Pagina As String = "Representantes_Ficha_Estabelecimento.aspx"
    ...
    Protected Sub cmb_EMAIL_REPRESENTANTE_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_EMAIL_REPRESENTANTE.SelectedIndexChanged
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=" & Request.QueryString("LINHA") & "&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    ...
    Protected Sub lnk_Todos_Click(sender As Object, e As EventArgs) Handles lnk_Todos.Click
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=Todos&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    Protected Sub lnk_Equipos_Edds_Click(sender As Object, e As EventArgs) Handles lnk_Equipos_Edds.Click
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=Equipos Edds&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    Protected Sub lnk_Equipos_Gemstar_Click(sender As Object, e As EventArgs) Handles lnk_Equipos_Gemstar.Click
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=Equipos Gemstar&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    Protected Sub lnk_Clave_Click(sender As Object, e As EventArgs) Handles lnk_Clave.Click
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=Clave&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    Protected Sub lnk_Supercath_Click(sender As Object, e As EventArgs) Handles lnk_Supercath.Click
        Response.Redirect("Representantes_Ficha_Estabelecimento.aspx?LINHA=Supercath&ANO=" & cmb_Ano.Text & "&REPRESENTANTE=" & cmb_EMAIL_REPRESENTANTE.Text)
    End Sub
    Public Sub Atualiza_Relatorio()
        ...
        If dtr_linha_produto.HasRows Then
            ...
            Do While dtr_linha_produto.Read
                ...
                sql_estabelecimento = "Select Distinct CNPJ, ESTABELECIMENTO_CNPJ From rpt_Representantes_Ficha_Estabelecimento WHERE COD_GRUPO_BOMBAS = '" & COD_GRUPO_BOMBA & "' AND EMAIL_REPRESENTANTE = '" & cmb_EMAIL_REPRESENTANTE.Text & "' Order By ESTABELECIMENTO_CNPJ"
    ...
    Private Sub Linha_Oportunidades_025(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        ...
        sql = sql & "WHERE (ANO_OPORTUNIDADE = " & ANO_ATUAL & ") AND (EMAIL_REPRESENTANTE = '" & EMAIL & "') AND (LINHA = '" & LINHA_PRODUTO & "')"
    ...
    Private Sub Linha_PREVISTO(LINHA_PRODUTO As String, TITULO_LINHA As String, Exibir As Boolean)
        'RECUPERA INFORMAÇÕES
        Dim JAN_PREVISTO As Integer = 0
        Dim FEV_PREVISTO As Integer = 0
        Dim MAR_PREVISTO As Integer = 0
        Dim ABR_PREVISTO As Integer = 0
        Dim MAI_PREVISTO As Integer = 0
        Dim JUN_PREVISTO As Integer = 0
        Dim JUL_PREVISTO As Integer = 0
        Dim AGO_PREVISTO As Integer = 0
        Dim SET_PREVISTO As Integer = 0
        Dim OUT_PREVISTO As Integer = 0
        Dim NOV_PREVISTO As Integer = 0
        Dim DEZ_PREVISTO As Integer = 0
        Dim TRI01_PREVISTO As Integer = 0
        Dim TRI02_PREVISTO As Integer = 0
        Dim TRI03_PREVISTO As Integer = 0
        Dim TRI04_PREVISTO As Integer = 0
        Dim TOTAL_PREVISTO As Integer = 0
        Dim YTD_PREVISTO As Integer = 0
