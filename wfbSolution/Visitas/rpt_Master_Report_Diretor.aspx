<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_Master_Report_Diretor.aspx.vb" Inherits="rpt_Master_Report_Diretor" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Master Report &nbsp;<asp:DropDownList ID="cmb_DIRETOR" runat="server" DataSourceID="dts_Diretores" DataTextField="NOME" DataValueField="EMAIL" AutoPostBack="True" Enabled="False"></asp:DropDownList>
    </div>
...
<div id ="Corpo">
    ...
    Gerente Regional
    <br />
    <asp:DropDownList ID="cmb_GERENTE" runat="server" DataSourceID="dts_Gerentes" DataTextField="GERENTE" DataValueField="EMAIL_GERENTE" AutoPostBack="True"></asp:DropDownList>
    <br />
     Representante
    <br />
 ...
 <br /> <br />
    ...
    <asp:SqlDataSource ID="dts_Linha" runat="server" 
        ...
        FROM  VIEW_DEMANDA_001_DETALHADO  WHERE ([EMAIL_DIRETOR] = @EMAIL_DIRETOR) ORDER BY [LINHA]">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Distribuidores" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_DISTRIBUIDOR UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO  WHERE ([EMAIL_DIRETOR] = @EMAIL_DIRETOR) ORDER BY GRUPO_DISTRIBUIDOR">
         <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Grupo_Estabeleicmento" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
        SelectCommand="SELECT '@' AS GRUPO, '@ Todos' as GRUPO_ESTABELECIMENTO UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE (GRUPO_ESTABELECIMENTO &lt;&gt;'') AND ([EMAIL_DIRETOR] = @EMAIL_DIRETOR) ORDER BY GRUPO_ESTABELECIMENTO">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
...
SELECT DISTINCT [COD_MUNICIPIO], [MUNICIPIO]  
    ...
    <asp:SqlDataSource ID="dts_Esfera" runat="server" 
        ConnectionString="<%$ ConnectionStrings:cnnStr %>" 
         SelectCommand="SELECT '@' AS ESFERA, '@ Todos' as ESFERA_ADMINISTRATIVA UNION ALL
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_DIRETOR] = @EMAIL_DIRETOR) ORDER BY ESFERA">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Diretores" runat="server" 
     ...
     <asp:SqlDataSource ID="dts_Gerentes" runat="server" 
        ...
        SelectCommand="SELECT '@' AS EMAIL_GERENTE, '@  Todos' as GERENTE UNION ALL 
                      ...
                      FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_DIRETOR] = @EMAIL_DIRETOR) ORDER BY GERENTE">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
     </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Representantes" runat="server" 
        ...
        SelectCommand="SELECT '@' AS EMAIL_REPRESENTANTE, '@  Todos' as REPRESENTANTE UNION ALL 
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE ([EMAIL_DIRETOR] = @EMAIL_DIRETOR)  ORDER BY REPRESENTANTE">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Gerente_Conta" runat="server" 
        ...
        SelectCommand="SELECT '@' AS EMAIL_GERENTE_CONTA, '@  Todos' as GERENTE_CONTA UNION ALL 
            ...
            FROM  VIEW_DEMANDA_001_DETALHADO WHERE(GERENTE_CONTA &lt;&gt; '') AND ([EMAIL_DIRETOR] = @EMAIL_DIRETOR)  ORDER BY GERENTE_CONTA">
    <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
    ...
    <asp:SqlDataSource ID="dts_Demanda" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_DEMANDA_001_DETALHADO] WHERE (([EMAIL_DIRETOR] = @EMAIL_DIRETOR) AND ([ANO] = @ANO))">
        <SelectParameters>
            <asp:SessionParameter Name="EMAIL_DIRETOR" SessionField="EMAIL_LOGIN" Type="String" />
