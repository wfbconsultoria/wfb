    ...
    Protected Sub btn_Gravar_Click(sender As Object, e As EventArgs) Handles cmd_Gravar.Click
        ...
        If Request.QueryString("INCLUSO_CLIENTE") = False Then
            ...
            If M.ExecutarSQL(sql) = True Then
                ...
                sql = sql & "'" & BAIRRO & "',"
                sql = sql & "'" & CEP & "',"
                If COD_IBGE = "" Or COD_IBGE = 0 Then
                    sql = sql & "'0000000',"
                Else
                    sql = sql & "'" & COD_IBGE & "',"
                End If
                ...
                If M.ExecutarSQL(sql) = True Then
                    ...
                    dtr = cmd.ExecuteReader
                    If dtr.HasRows Then
                        Alert("Este cliente já está setorizado!", True, "Estabelecimentos_Pesquisa_RF.aspx")
                    Else
                        ...
                        Else
                            ...
                            Alert("Cliente incluido, mas não setorizado! O Erro foi enviado ao suporte e será analisado!", True, "Estabelecimentos_Pesquisa_RF.aspx")
                        End If
                    End If
                    dtr.Close()
                    Exit Sub
