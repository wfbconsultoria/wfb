<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_ReVisitas.aspx.vb" Inherits="rpt_Visitas" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Re Visitas Mês <asp:DropDownList ID="cmb_Mes" runat="server" AutoPostBack="True" DataSourceID="dts_Meses" DataTextField="MES_EXTENSO" DataValueField="MES_SIGLA"></asp:DropDownList>
...
<div id ="Corpo">
    <rsweb:ReportViewer ID="rptVisitas" runat="server" Height="403px" Width="100%" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
        <LocalReport ReportPath="Reports\rpt_ReVisitas.rdlc">
            <DataSources>
