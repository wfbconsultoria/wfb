...
Partial Class Setorizacao
    Inherits System.Web.UI.Page
    Dim M As New clsMaster
    Dim Pagina As String = "Setorizacao.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
        'CONTROLA OS ACESSOS E FUNÇÕES CONFORME O PERFIL DE ACESSO
        SQL = ""
        ...
        If Session("COD_PERFIL_LOGIN") = "4" Then SQL = "Select * From VIEW_USUARIOS_ATIVOS Where EMAIL = '" & Session("EMAIL_LOGIN") & "'"
    ...
    Protected Sub cmd_Gravar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_Gravar.Click
        ...
        For Each gdvrow As GridViewRow In gdv_Localizar.Rows
            ...
            TARGET = CType(gdvrow.Cells(3).FindControl("cmb_TARGET"), DropDownList).Text
            ...
            If M.ExecutarSQL(SQL) = False Then
                ...
                Alert("As atualizações não foram efetuadas, um e-mail foi enviado ao administrador do sistema para correções", False, "")
                Exit Sub
            End If
