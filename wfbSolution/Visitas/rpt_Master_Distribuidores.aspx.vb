...
Partial Class rpt_Master_Distribuidores
    Inherits System.Web.UI.Page
    Dim M As New clsMaster
    Dim Pagina As String = "rpt_Master_Distribuidores.aspx"
    Dim sql As String

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        'If Session("COD_PERFIL_LOGIN") = "0" Then Response.Redirect("rpt_Master_Report.aspx")
        If Session("COD_PERFIL_LOGIN") = "1" Then GoTo Grava_log
        If Session("COD_PERFIL_LOGIN") = "2" Then GoTo Grava_log
        If Session("COD_PERFIL_LOGIN") = "3" Then GoTo Grava_log
