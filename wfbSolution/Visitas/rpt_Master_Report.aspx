...
<div id ="Corpo">
    ...
    <br />
     Gerente Nacional
    <br />
    <asp:DropDownList ID="cmb_DIRETOR" runat="server" DataSourceID="dts_Diretores" DataTextField="DIRETOR" DataValueField="EMAIL_DIRETOR" AutoPostBack="True"></asp:DropDownList>
    <br />
    Gerente Regional
    <br />
