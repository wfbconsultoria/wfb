...
<body>
 ...
 <div id="Titulo_Pagina">
    ...
    <div id ="Titulo_Pagina_Links">
        <asp:HyperLink ID="lnk_Help" runat="server" NavigateUrl="~/Default_Help.aspx" Target="_blank">Ajuda</asp:HyperLink>&nbsp
        <asp:HyperLink ID="lnk_Logout" runat="server" NavigateUrl="~/Login.aspx">Sair</asp:HyperLink>
    </div>
</div>
<br />
<div id ="Corpo">
