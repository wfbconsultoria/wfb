<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpt_Estoque_Distribuidor.aspx.vb" Inherits="rpt_Estoque_Distribuidor" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Estoque Detalhado Por Produto</div>
...
<div id ="Corpo">
    ...
    &nbsp;<br />
    <br/>
    <span class="auto-style3">Estoque informado até Fevereiro de 2015.
    </span>
    <br/>
    <span class="auto-style4">Estoque calculado a partir do mês de Março de 2015. </span>
    <br />
    <br/>
    <span class="auto-style5">*Obs.: Os valores de estoque até Fevereiro de 2015 foram informados através de mapas enviados pelos disitribuidores.
    </span>
    <br />
