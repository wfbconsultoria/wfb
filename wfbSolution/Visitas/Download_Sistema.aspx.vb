...
Partial Class Download_Sistema
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Public jscript As String
    Dim Pagina As String = "Download_Sistema.aspx"
    Dim Titulo As String = "Download Sistema - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
