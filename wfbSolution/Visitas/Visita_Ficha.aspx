...
<div id="Titulo_Pagina">
    ...
    <!--<a href="Visitas_Editar.aspx?ID_VISITA=<%=Session("ID_VISITA")%>">Alterar</a>&nbsp;-->
    <% If (Session("PAGINA") = "1") Then%>
        <a href="Estabelecimentos_Ficha2.aspx?CNPJ=<%=Session("CNPJ")%>">Voltar para estabelecimento</a>
    <% ElseIf (Session("PAGINA") = "2") Then%>
            <a href="Medicos_Ficha.aspx?CRMUF=<%=Session("CRMUF")%>">Voltar para Ficha do Médico</a>
    <% ElseIf (Session("PAGINA") = "3") Then%>
        <a href="Contatos_Ficha.aspx?ID=<%=Session("ID_CONTATO")%>">Voltar para Ficha do Contato</a>
    <% End If%>
    </div>
</div>
<br />
<div id ="Corpo">
    ...
    <asp:FormView ID="FormView1" runat="server" DataSourceID="dts_Visita" Width="793px">
        ...
        <ItemTemplate>
            ...
            <br />
            <strong>Data:</strong>
            <asp:Label ID="DATA_VISITALabel" runat="server" style="font-weight: 700" Text='<%# Bind("DATA") %>' />
            &nbsp;-
            ...
            <asp:Label ID="PROXIMA_VISITALabel" runat="server" style="font-weight: 700" Text='<%# Bind("PROXIMA_VISITA") %>' />
            <br />
            <br />
    ...
    <asp:SqlDataSource ID="dts_Visita" runat="server" ConnectionString="<%$ ConnectionStrings:cnnStr %>" SelectCommand="SELECT * FROM [VIEW_VISITAS_GERAL] WHERE ([ID_VISITA] = @ID_VISITA)">
        <SelectParameters>
