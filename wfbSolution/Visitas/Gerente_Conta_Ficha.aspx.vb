Imports System.Math
Partial Class Gerente_Conta_Ficha
    Inherits System.Web.UI.Page
    Dim M As New clsMaster
    Dim Pagina As String = "Gerente_Conta_Ficha.aspx"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("COD_PERFIL_LOGIN") = "3" Then sql = "Select * From VIEW_USUARIOS_ATIVOS Where EMAIL= '" & Session("EMAIL_LOGIN") & "'"
    ...
    Protected Sub Page_LoadComplete(sender As Object, e As EventArgs) Handles Me.LoadComplete
        Atualiza_Relatorio()
    End Sub
    Protected Sub cmb_EMAIL_GERENTE_CONTA_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_EMAIL_GERENTE_CONTA.SelectedIndexChanged
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=" & Request.QueryString("LINHA") & "&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
    ...
    Protected Sub lnk_Todos_Click(sender As Object, e As EventArgs) Handles lnk_Todos.Click
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=Todos&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
    Protected Sub lnk_Equipos_Edds_Click(sender As Object, e As EventArgs) Handles lnk_Equipos_Edds.Click
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=Equipos Edds&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
    Protected Sub lnk_Equipos_Gemstar_Click(sender As Object, e As EventArgs) Handles lnk_Equipos_Gemstar.Click
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=Equipos Gemstar&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
    Protected Sub lnk_Clave_Click(sender As Object, e As EventArgs) Handles lnk_Clave.Click
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=Clave&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
    Protected Sub lnk_Supercath_Click(sender As Object, e As EventArgs) Handles lnk_Supercath.Click
        Response.Redirect("GERENTE_CONTA_Ficha.aspx?LINHA=Supercath&ANO=" & cmb_Ano.Text & "&GERENTE_CONTA=" & cmb_EMAIL_GERENTE_CONTA.Text)
    End Sub
