...
Partial Class Estabelecimentos_Ficha_Inventario_Bombas_Distribuidor
    Inherits System.Web.UI.Page
    Dim M As New clsMaster
    Dim Pagina As String = "Estabelecimentos_Ficha_Inventario_Bombas_Distribuidor.aspx"
    ...
    Protected Sub cmd_Gravar_Click(sender As Object, e As EventArgs) Handles cmd_GRAVAR.Click
        ...
        sql = ""
        sql = sql & " Insert Into TBL_BOMBAS_INVENTARIO_DISTRIBUIDOR "
        sql = sql & " ("
        sql = sql & "CNPJ, "
        ...
        If M.ExecutarSQL(sql) = True Then
            ...
            Alert("INCLUSÃO REALIZADA COM SUCESSO", True, "Estabelecimentos_Ficha.aspx?CNPJ=" & Session("CNPJ"))
        Else
