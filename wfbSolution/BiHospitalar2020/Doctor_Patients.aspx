<%@ Page Title="Pacientes" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Master.Master" CodeBehind="Doctor_Patients.aspx.vb" Inherits="BiHospitalar2020.Doctor_Patients" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-row">
        ...
        <div class="form-group col-sm-10">
            <label class="text-secondary">Médico</label>
