<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/_Master.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="SiteTemplate.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="SiteTemplate" %>
