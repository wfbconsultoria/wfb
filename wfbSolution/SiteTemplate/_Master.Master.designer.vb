...
Partial Public Class _Master
    ...
    '''<summary>
    '''Controle LoginView_Left.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents LoginView_Left As Global.System.Web.UI.WebControls.LoginView
    
    '''<summary>
    '''Controle LoginView_Right.
    '''</summary>
    '''<remarks>
    '''Campo gerado automaticamente.
    '''Modificar a declaração do campo de movimento do arquivo de designer para o arquivo code-behind.
    '''</remarks>
    Protected WithEvents LoginView_Right As Global.System.Web.UI.WebControls.LoginView
