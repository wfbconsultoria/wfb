...
Partial Class Medico_Consulta_CRM
    ...
    Private Sub Medico_Consulta_CRM_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If m.CheckQueryString("IdEstabelecimento") = False Then
            m.Alert(Me, "Selecione o estabelecimento onde deseja incluir o médico", True, "Estabelecimentos.aspx")
        Else
            IdEstabelecimento = Estabelecimento_Cabecalho.ID_ESTABELECIMENTO
