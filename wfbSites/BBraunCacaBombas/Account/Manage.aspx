<%@ Page Title="Trocar Senha" Language="VB" MasterPageFile="~/_Logged.master" AutoEventWireup="true" CodeFile="Manage.aspx.vb" Inherits="Account_Manage" %>
            ...
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Change password" OnClick="ChangePassword_Click" CssClass="btn btn-success" ValidationGroup="ChangePassword" />
                            </div>
                        </div>
                    </div>
                </asp:PlaceHolder>
