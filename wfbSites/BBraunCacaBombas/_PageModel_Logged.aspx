<%@ Page Title="Página Restrita" Language="VB" MasterPageFile="~/_Logged.master" AutoEventWireup="false" CodeFile="_PageModel_Logged.aspx.vb" Inherits="_PageModel_Logged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" Runat="Server">
   <div class="row d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom">
    ...
    <%--Conteudo da página--%>
    <div>
        Conteudo da página, RESTRITO, exige autenticação
    </div>
