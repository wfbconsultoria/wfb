...
Partial Class Download
    ...
    Private Sub Download_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim dtr As System.Data.SqlClient.SqlDataReader = m.ExecuteSelect("SELECT ID, DOWNLOAD_TITLE, DOWNLOAD_DESCRIPTION, DOWNLOAD_LINK, Insert_User, Insert_Date From vw_Downloads_Users Where Active = 1 and USER_EMAIL = '" & Session("USER_EMAIL").ToString & "'" & "ORDER BY DOWNLOAD_TITLE ASC")
