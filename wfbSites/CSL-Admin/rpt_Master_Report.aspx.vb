...
Partial Class rpt_Master_Report
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("COD_PERFIL_LOGIN") = 6 Then Acesso = true 'Visitante
    ...
    Public Sub Atualiza_Relatório()
        ...
        'ESFERA
        If cmb_TARGET.Text <> "@" Then sql = sql & " and TARGET = '" & cmb_TARGET.Text & "' "

        If chk_Sem_Setorização.Checked = True Then
        ...
        Else
            ...
            'GERENTE Distrital
            If cmb_GERENTE_DISTRITAL.Text <> "@" And cmb_GERENTE_DISTRITAL.Text <> "" Then sql = sql & " and EMAIL_COORDENADOR = '" & cmb_GERENTE_DISTRITAL.Text & "' "
            'REPRESENTANTE
    ...
    Protected Sub chk_Sem_Setorização_CheckedChanged(sender As Object, e As EventArgs) Handles chk_Sem_Setorização.CheckedChanged

        If chk_Sem_Setorização.Checked = True Then
            cmb_DIRETOR.Text = "@"
            cmb_GERENTE.Text = "@"
            'cmb_GERENTE_DISTRITAL.Text = "@"
            cmb_REPRESENTANTE.Text = "@"
            cmb_GERENTE_CONTA.Text = "@"
        ...
        Else
            cmb_DIRETOR.Enabled = True
            cmb_GERENTE.Enabled = True
            cmb_GERENTE_DISTRITAL.Enabled = True
            cmb_REPRESENTANTE.Enabled = True
            cmb_GERENTE_CONTA.Enabled = True
        End If
    ...
    Protected Sub cmb_GERENTE_DISTRITAL_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cmb_GERENTE_DISTRITAL.SelectedIndexChanged
        Atualiza_Relatório()
    End Sub
    ...
    Public Sub Carrega_Controle()
        ...
        Else
            If Session("COD_PERFIL_LOGIN") = 0 Then 'Administrador 
                ...
                'Grupo ESFERA
                dts_Esfera.SelectCommand = "SELECT '@' AS ESFERA_ADMINISTRATIVA, '# Todos' as ESFERA UNION ALL SELECT DISTINCT [ESFERA] AS ESFERA_ADMINISTRATIVA, [ESFERA] FROM [" & VIEW_TIPO_MOVIMENTO & " ] WHERE (ESFERA<>'') ORDER BY [ESFERA]"
                dts_Esfera.DataBind()
    ...
    Public Sub Controle_Hierarquia()
        ...
        If Session("COD_PERFIL_LOGIN") = 10 Then 'Gerente de Conta
            ...
            End If
             ...
             If Session("COD_PERFIL_LOGIN") = 3 Then 'Gerente Distrital
            'Libera o Filtro de não setorizados
            chk_Sem_Setorização.Enabled = False
