...
Partial Class Visitas_Agenda
    Inherits System.Web.UI.Page
    'Variaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Visita_Agenda.aspx"
    Dim Titulo As String = "Agenda de Visitas - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
    ...
    Protected Sub cmd_Excel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmd_Excel.Click
        ...
        gdv_Agenda.Caption = "Agenda"
        gdv_Agenda.AllowPaging = "False"
        gdv_Agenda.DataBind()
        Dim tw As New System.IO.StringWriter()
        Dim hw As New System.Web.UI.HtmlTextWriter(tw)
        Dim frm As HtmlForm = New HtmlForm()
        Response.ContentType = "application/vnd.ms-excel"
        Response.AddHeader("content-disposition", "attachment;filename=AGENDA.xls")
        Response.Charset = ""
        EnableViewState = False
        Controls.Add(frm)
        frm.Controls.Add(gdv_Agenda)
        frm.RenderControl(hw)
        Response.Write(tw.ToString())
        Response.End()
        gdv_Agenda.AllowPaging = "True"
        gdv_Agenda.DataBind()
    End Sub
End Class