...
Partial Class rpt_Concurso_Alburex
    Inherits System.Web.UI.Page

    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "rpt_Concurso_Alburex.aspx"
    Dim Titulo As String = "Concurso Alburex - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
