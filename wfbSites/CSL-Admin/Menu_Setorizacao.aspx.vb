...
Partial Class Menu_Setorizacao
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Menu_Setorizacao.aspx"
    Dim Titulo As String = "Setorização - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
