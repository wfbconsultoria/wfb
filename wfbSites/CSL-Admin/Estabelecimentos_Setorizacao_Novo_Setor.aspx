<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Estabelecimentos_Setorizacao_Novo_Setor.aspx.vb" Inherits="Estabelecimentos_Setorizacao_Novo_Setor" %>
...
<div id="Titulo_Pagina">
    <div id ="Titulo_Pagina_Cabecalho">Novo Setor</div>
...
<div id ="Corpo">
    <br />
    <span class="auto-style8">Nesta página é possível</span> 
    <span class="auto-style7"> criar um novo setor</span>
    <span class="auto-style8"> para o representante selecionado</span>
    <br class="auto-style8" />
    <span class="auto-style8">Para </span>
    <span class="auto-style9">incluir </span><span class="auto-style8">você deverá </span>
    <span class="auto-style8">selecionar os clientes que deseja setorizar, para o representante selecionado,</span>
    <br />
    <b> e clique em</b> &nbsp; <asp:Button ID="cmd_Gravar" runat="server" Text="Gravar" />
    <br />
    <br />
    <b>Selecione o representante para que deseja criar o setor</b><br />
    <asp:DropDownList 
        ID="cmb_EMAIL_REPRESENTANTE" runat="server" AutoPostBack="True" 
        DataSourceID="dts_Usuarios" DataTextField="NOME" 
        DataValueField="EMAIL">
    </asp:DropDownList>
    <br />
    <strong>Filtros de Pesquisa</strong><br />
    Estado
    <br />
    ...
    DataSourceID="dts_Localizar" Width="100%" DataKeyNames="CNPJ" HorizontalAlign="Left" AllowSorting="True">
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Setorizar">
                <EditItemTemplate>
                    <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("EXCLUIDO") %>'></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:CheckBox ID="chk_Setorizar" runat="server" />
                </ItemTemplate>
                <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                </asp:TemplateField>
    ...
    FROM  VIEW_ESTABELECIMENTOS_001_DETALHADO  ORDER BY ESFERA_ADMINISTRATIVA">
    </asp:SqlDataSource>
    ...
    FROM  VIEW_ESTABELECIMENTOS_001_DETALHADO ORDER BY UF_DESC">
    </asp:SqlDataSource>
    ...
    FROM  VIEW_ESTABELECIMENTOS_001_DETALHADO  ORDER BY MUNICIPIO_DESC">
    </asp:SqlDataSource>
