...
Partial Class Menu_Distribuidor
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Menu_Distribuidor.aspx"
    Dim Titulo As String = "Distribuidor - " & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
