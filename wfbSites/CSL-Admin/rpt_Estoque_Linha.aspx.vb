...
Partial Class rpt_Estoque_Linha
    ...
    Public Sub Atualiza_Relatorio()
        ...
        If LINHA_PRODUTO <> "# Selecione" Then
            'ABRE CONEXÕES
            ...
            'RECUPERA ESTOQUE
            sql = ""
            sql = "SELECT * FROM VIEW_DISTRIBUIDORES_MOVIMENTO_001_AGRUPADO_TOTAL_GERAL_FISCAL_UN_OR WHERE TIPO = 'ESTOQUE UNIDADES ORIGINAL FISCAL' AND ANO = " & ANO & " AND LINHA = '" & LINHA_PRODUTO & "'"
