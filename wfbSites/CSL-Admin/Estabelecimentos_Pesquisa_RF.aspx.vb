...
Partial Class Estabelecimentos_Pesquisa_RF
    ...
    Protected Sub cmd_Consultar_Click(sender As Object, e As System.EventArgs) Handles cmd_Consultar.Click
        ...
        SQL = ""
        SQL = "Select *  From VIEW_ESTABELECIMENTOS_001_DETALHADO Where CNPJ = " & DOCUMENTO & " AND COD_TIPO_PESSOA = '" & cmb_TIPO_PESSOA.Text & "'"
        cmd.Connection = cnn
        cmd.CommandText = SQL
        ...
        dtr.Close()
        cnn.Close()
        'PESQUISA NA RECEITA FEDERAL E INCLUI NOS DOIS BANCO DE DADOS RECEITA E CLEINTE
