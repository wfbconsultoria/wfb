    ...
    <table width="100%" >
        <tr>
            ...
            <td width="30%" style="vertical-align: top;">
                ...
                Últimos Downloads do arquivo.<asp:GridView ID="gdv_LOG_DOWNLOAD" runat="server" AutoGenerateColumns="False" DataSourceID="dts_LOG_DOWNLOAD" Width="100%" Height="100%" ShowHeader="false">
                    <Columns>
