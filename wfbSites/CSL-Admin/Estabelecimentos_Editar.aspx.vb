...
Partial Class Estabelecimentos_Editar
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Dim Pagina As String = "Estabelecimentos_Editar.aspx"
    Dim Titulo As String = "Alterar Cliente" & ConfigurationManager.AppSettings("NOME_SISTEMA").ToString
    ...
    Protected Sub frm_ESTABELECIMENTO_EDITAR_ItemUpdated(sender As Object, e As FormViewUpdatedEventArgs) Handles frm_ESTABELECIMENTO_EDITAR.ItemUpdated
        sql = ""
        sql = "Update TBL_ESTABELECIMENTOS SET ALTERACAO_EMAIL = '" & Session("EMAIL_LOGIN") & "', ALTERACAO_DATA = '" & M.RecuperaData & "' WHERE CNPJ = " & CNPJ
        M.ExecutarSQL(sql)
    End Sub
