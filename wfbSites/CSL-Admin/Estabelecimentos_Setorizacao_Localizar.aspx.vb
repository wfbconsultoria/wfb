...
Partial Class Estabelecimentos_Setorizacao_Localizar
    Inherits System.Web.UI.Page
    'Váriaveis Padrão
    Dim M As New clsMaster
    Public jscript As String
    Dim Pagina As String = "Estabelecimentos_Setorizacao_Localizacao.aspx"
    ...
    Protected Sub Atualiza_Relatório()
        sql = " Select * From VIEW_SETORIZACAO WHERE CNPJ <> 0 "
    ...
    Protected Sub cmd_Gravar_Click(sender As Object, e As System.EventArgs) Handles cmd_Gravar.Click
        ...
        For Each gdvrow As GridViewRow In gdv_Localizar.Rows
            ...
            sql = "SELECT CNPJ FROM TBL_SETORIZACAO WHERE CNPJ = " & M.Converte_Valor(CNPJ) & " AND EMAIL = '" & EMAIL & "'"
            cmd.Connection = cnn
            cmd.CommandText = SQL
            ...
            If dtr.HasRows Then
                ...
                If EMAIL <> cmb_EMAIL_REPRESENTANTE.Text Or EXCLUIR = True Then
                    sql = "DELETE FROM TBL_SETORIZACAO WHERE CNPJ = " & M.Converte_Valor(CNPJ) & " AND EMAIL = '" & cmb_EMAIL_REPRESENTANTE.Text & "'"
