...
Partial Class Estabelecimentos_Ficha_Contatos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'RECUPERA REGISTRO
        sql = ""
        sql = "Select * From VIEW_SETORIZACAO Where CNPJ = '" & Request.QueryString("CNPJ") & "'"
        cmd.CommandText = sql
        dtr = cmd.ExecuteReader
        If dtr.HasRows Then
            dtr.Read()
        Else
            gdv_CONTATOS.Enabled = False
            gdv_Visitas_Contatos.Enabled = False
            If Request.QueryString("ORFAO") <> "True" Then
                Response.Redirect("Estabelecimentos_Ficha.aspx?CNPJ=" & Request.QueryString("CNPJ") & "&ORFAO=True")
            End If
        End If
